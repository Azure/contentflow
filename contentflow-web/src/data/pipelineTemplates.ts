...
pipeline:
  ...
  executors:
    - id: blob-input-1
      ...
      type: azure_blob_input
      position: { x: 250, y: 50 }
      description: "Load article documents"
      settings:
    ...
    - id: entity-1
      ...
      settings:
        entity_types: ["PERSON", "ORG", "EVENT", "CONCEPT"]
...
pipeline:
  ...
  executors:
    - id: blob-input-1
      ...
      type: azure_blob_input
      position: { x: 250, y: 50 }
      description: "Load multiple documents for analysis"
      settings:
    ...
    - id: field-mapper-1
      ...
      type: field_mapper
      position: { x: 250, y: 500 }
      description: "Structure data for knowledge graph"
      settings:
    ...
    - id: blob-output-1
      ...
      description: "Save knowledge graph"
...
pipeline:
  ...
  executors:
    - id: blob-input-1
      ...
      type: azure_blob_input
      position: { x: 200, y: 50 }
      description: "Load images from storage"
      settings:
...
pipeline:
  ...
  executors:
    ...
    - id: ppt-extractor-1
      ...
      description: "Extract from presentations"
      settings:
        extract_slides: true
        extract_notes: true
    ...
    - id: excel-extractor-1
      ...
      description: "Extract from spreadsheets"
      settings:
        extract_sheets: true
...
// Template 8: Content Understanding & Classification
...
pipeline:
  ...
  executors:
    ...
    - id: content-understanding-1
      ...
      type: azure_content_understanding_extractor
      position: { x: 250, y: 150 }
      description: "Extract content with Azure AI"
      settings:
        analyzer: "prebuilt-documentSearch"
        output_content_format: "markdown"
...
export const pipelineTemplates: PipelineTemplate[] = [
  ...
  },
  {
    ...
    yaml: multiFormatYaml,
    ...createPipelineFromYaml(multiFormatYaml),
  },
  {
