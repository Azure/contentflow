...
export const pipelineTemplatesOld: PipelineTemplate[] = [
  {
    id: "pdf-extraction",
    ...
    useCases: [
      "Healthcare: Extract patient records, clinical trial data, and medical research papers for electronic health record (EHR) systems and medical knowledge bases",
      "Finance: Parse invoices, receipts, bank statements, and financial reports to automate accounts payable/receivable and regulatory compliance documentation",
      "Legal: Convert contract PDFs, case law documents, and legal briefs into structured data for case management and e-discovery systems",
      "Education: Process academic papers, textbooks, and course materials for digital libraries and learning management systems",
      "Insurance: Extract data from policy documents, claims forms, and underwriting reports for automated claims processing",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      "Media & Publishing: Automatically generate article summaries for newsletters, content aggregation platforms, and news digests to increase reader engagement and content distribution",
      "Corporate Communications: Create executive summaries from quarterly reports, board meeting minutes, and strategy documents for leadership teams and stakeholders",
      "Market Research: Summarize competitor analyses, industry reports, and market trends for strategic planning and business intelligence",
      "Healthcare: Condense medical research papers, clinical guidelines, and patient education materials for physicians and care teams",
      "Technology: Generate concise summaries of technical documentation, API changes, and product updates for developer communities",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      "Life Sciences: Build comprehensive knowledge graphs from research papers, clinical trials, and drug interaction databases to accelerate drug discovery and understand disease pathways",
      "Financial Services: Map relationships between companies, executives, transactions, and regulatory filings for investment analysis, risk assessment, and fraud detection",
      "Manufacturing: Create supply chain knowledge graphs mapping suppliers, components, dependencies, and logistics for supply chain optimization and risk management",
      "Technology: Extract entities from technical documentation to build API relationship maps, dependency graphs, and system architecture visualizations",
      "Legal: Map legal precedents, case relationships, and regulatory compliance requirements for legal research and compliance management",
    ],
    features: [
  ...
  },
  {
    ...
    estimatedTime: "1-2 min",
    useCases: [
      "Customer Service: Analyze support email threads to extract action items, detect customer sentiment, and automatically route urgent issues to appropriate teams for faster response times",
      "Sales & Marketing: Categorize incoming leads, identify high-priority prospects, extract meeting requests and follow-up tasks to improve sales pipeline management and customer relationship management",
      "Legal: Automatically categorize legal correspondence, identify contract negotiation points, extract deadlines and obligations from email threads for matter management",
      "Project Management: Extract action items, deadlines, and deliverables from project email threads to automatically update task management systems and track project milestones",
      "Human Resources: Analyze employee communications for sentiment, categorize HR inquiries, and prioritize urgent requests for employee relations and support",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      "Healthcare: Digitize handwritten clinical notes, extract text from medical imaging reports, and generate descriptions of medical images for electronic health records and accessibility compliance",
      "Education: Convert handwritten student assignments and whiteboard notes into searchable digital text, extract content from educational screenshots and diagrams for learning management systems",
      "Retail & E-commerce: Extract product information from images, generate alt-text for product photos for SEO and accessibility, and analyze visual content in customer reviews",
      "Insurance: Process handwritten claims forms, extract data from accident scene photos, and analyze damage assessment images for automated claims processing",
      "Real Estate: Extract text from property documents, generate descriptive metadata for property images, and digitize handwritten property notes for listing management",
    ],
    features: [
  ...
  },
  {
    ...
    estimatedTime: "3-5 min",
    useCases: [
      "Enterprise IT: Build comprehensive knowledge bases from technical documentation, support tickets, and internal wikis to power AI-powered helpdesks and reduce IT support overhead",
      "Financial Services: Process regulatory documents, compliance manuals, and internal policies for AI-powered compliance assistants and regulatory Q&A systems accessible to all employees",
      "Healthcare: Index medical guidelines, drug databases, and clinical protocols for AI-powered clinical decision support systems that help physicians find relevant information quickly",
      "Legal Services: Create searchable repositories of case law, contracts, and legal precedents for AI-assisted legal research and contract analysis tools",
      "Manufacturing: Process equipment manuals, maintenance procedures, and safety documents for AI-powered maintenance support systems and technician assistance tools",
    ],
    features: [
  ...
  },
  {
    ...
    estimatedTime: "5-8 min",
    useCases: [
      "Enterprise IT Services: Build comprehensive technical knowledge bases from IT documentation, runbooks, and support tickets to power AI-assisted helpdesks that reduce mean time to resolution and improve first-call resolution rates",
      "Manufacturing: Index equipment manuals, maintenance procedures, safety protocols, and engineering specifications to create AI-powered maintenance support systems that help technicians troubleshoot issues and perform preventive maintenance",
      "Professional Services: Process project documentation, methodology guides, and past deliverables to create searchable knowledge repositories that help consultants find relevant templates, best practices, and case studies",
      "Government & Public Sector: Index policy documents, regulations, and procedural manuals to create AI-powered citizen service portals and internal knowledge systems that improve response times and ensure consistent information delivery",
      "Telecommunications: Process network documentation, troubleshooting guides, and service manuals to build AI-assisted support systems that help customer service representatives resolve technical issues faster",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      "Engineering & Manufacturing: Index technical specifications, CAD drawings, assembly instructions, and product diagrams to create AI-powered engineering knowledge bases where teams can search for specific component designs, wiring diagrams, or assembly sequences across visual and text content",
      "Scientific Research: Process research papers containing complex charts, molecular structures, experimental diagrams, and data tables to build searchable scientific databases where researchers can find specific experiments, data visualizations, or methodologies",
      "E-commerce & Retail: Build product catalogs combining product images, specification tables, user manual diagrams, and descriptive text for AI-powered product search that understands both visual and textual queries",
      "Healthcare & Medical: Index medical literature with anatomical diagrams, radiology images, treatment flowcharts, and clinical data tables to create comprehensive medical knowledge systems for clinical decision support and medical education",
      "Architecture & Construction: Process architectural plans, blueprints, specification sheets, and construction photos to build searchable project repositories where teams can find specific design elements, materials, or construction details",
    ],
    features: [
  ...
  },
  {
    ...
    estimatedTime: "3-5 min",
    useCases: [
      "Corporate HR & Talent Acquisition: Screen thousands of resumes for multiple job openings, extract skills, experience, and qualifications, match candidates to job requirements, and create ranked candidate pools while ensuring unbiased, EEOC-compliant evaluation processes",
      "Recruitment Agencies & Staffing Firms: Process candidate resumes at scale, build searchable talent databases with skill taxonomies, match candidates to client job requirements, and accelerate placement cycles while maintaining candidate privacy and data protection",
      "Technology Companies: Screen technical resumes for software engineering, data science, and IT roles, extract programming languages, frameworks, certifications, and GitHub profiles, and identify candidates with specific technical skill combinations",
      "Healthcare Staffing: Process medical professional resumes, extract certifications, licenses, specializations, and clinical experience, verify credentials, and match qualified candidates to healthcare facilities based on regulatory requirements",
      "Executive Search Firms: Analyze executive resumes and LinkedIn profiles to extract leadership experience, board memberships, industry expertise, and accomplishments, building executive talent pools for C-suite and senior leadership searches",
    ],
    features: [
